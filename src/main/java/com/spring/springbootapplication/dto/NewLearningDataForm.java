...
@Data
@NoArgsConstructor
public class NewLearningDataForm {
    ...
    public NewLearningDataForm(List<LearningDataDto> backendList, List<LearningDataDto> frontendList, List<LearningDataDto> infraList, YearMonth month) {
